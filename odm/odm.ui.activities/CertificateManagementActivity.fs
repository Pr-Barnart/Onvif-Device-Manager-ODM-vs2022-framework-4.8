...
type CertificateManagementActivity(ctx: IUnityContainer) =
        ...
        let! cont = async {
            try
                ...
                | Selected filePath ->
                    ...
                    let! res =
                        CertificateUploadView.Show(
                            ctx,
                            new CertificateUploadView.Model(cert)
                        )
